...
export const ReceivablesDashboard = () => {
  const { propsContextValue, dataContextValue, filtersContextValue, paginationContextValue, selectionContextValue } =
    useReceivables()

  const { displayOptions } = propsContextValue

  const { statusTabsMetrics, metricsData, isMetricsLoading, isRefreshLoading, handleRefresh } = dataContextValue
