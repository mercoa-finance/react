...
// TODO: Refactor code duplication between this component and `PayablesTable`'s `DeleteInvoiceDialog`
// This is a perfect copy of `PayablesTable`'s `DeleteInvoiceDialog`!
    ...
    <Dialog open={open} onOpenChange={(_open) => setOpen(_open)}>
      <div className="mercoa-w-[320px] mercoa-flex mercoa-flex-col mercoa-relative mercoa-bg-white mercoa-text-[#1A1919] mercoa-p-[1rem] mercoa-rounded-[8px]">
        <div className="mercoa-text-left">
          <h3 className="mercoa-text-[16px] mercoa-font-semibold mercoa-text-[#1A1919]">Delete Invoice?</h3>
