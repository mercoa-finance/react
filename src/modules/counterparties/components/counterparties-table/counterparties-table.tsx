...
import { SearchIcon } from '../../../payables/assets/icons'
...
const CellRenderer = React.memo(({ cell }: { cell: any }): React.ReactElement => {
  return flexRender(cell.column.columnDef.cell, cell.getContext()) as React.ReactElement
})
