...
export const useCounterpartySearchInternal = (props: CounterpartySearchProps): CounterpartySearchContextValue => {
      ...
      vendor: {
        ...
        email:
          defaultSelectedCounterparty?.accountType === 'business'
            ? defaultSelectedCounterparty?.profile?.business?.email ?? selectedCounterparty?.profile?.business?.email
            : defaultSelectedCounterparty?.profile?.individual?.email ??
