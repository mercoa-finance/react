...
export type PayablesQueryOptions = {
...
export type PayablesDisplayOptions = {
...
export const Payables: FC<PayablesProps> = memo(({ queryOptions, renderCustom, displayOptions, handlers, config }) => {
  ...
  const queryData = usePayablesTable({
    initialQueryOptions: queryOptions?.isInitial ? queryOptions : undefined,
    currentQueryOptions: queryOptions?.isInitial ? undefined : queryOptions,
  })
...
Payables.displayName = 'PayablesDashboardV2'
