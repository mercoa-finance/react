...
export const TableActionDropdown: FC<TableActionDropdownProps> = ({ validActions, onAction, trigger }) => {
  ...
  const tableActions = [
    { label: 'Approve', actionKey: 'approve', disabled: !validActions.includes('approve') },
    { label: 'Schedule Payment', actionKey: 'schedulePayment', disabled: !validActions.includes('schedulePayment') },
    { label: 'Delete', actionKey: 'delete', disabled: !validActions.includes('delete') },
  ]
