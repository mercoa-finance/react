...
The `<PayablesTableV1>` renders a list of invoices that can be selected or actioned on. The component supports multiple filtering options to let you get the data you need, and provides out of the box pagination support.
