...
If an entity group token passes in, this component will render the email address for the entity group unless an entity selects at the `MercoaSession` level.
