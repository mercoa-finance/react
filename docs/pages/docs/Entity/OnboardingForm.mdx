...
Most of the time, you should use the [<EntityOnboarding> component](/Entity/Onboarding), but if you want to process the data before you send it to Mercoa, you can use this component.
