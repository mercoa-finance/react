...
| administrator       | `boolean`                              |          | If true, will show all fields as well as additional fields like `isPayor` and `isPayee`. Useful to build internal administrator dashboards. |
