...
| theme                 | `'light' \| 'dark'`                                                                  |          |                                                                            |
| downloadButton        | `({ onClick }: { onClick: () => void }) => JSX.Element`                              |          | Override for download button                                                                                                                                 |
...
The `PayableDocument` component consists of multiple sub-components that can all be customized. Additionally, you can mix in your own custom components to further control the UX.

<Callout>
All of the sub-components must be children of a `PayableDocument` component
</Callout>
