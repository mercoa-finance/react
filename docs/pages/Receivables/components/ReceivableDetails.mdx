...
| ---------------- | ------------------------------------------------------------ | -------- | -------------------------------------------------------------------------------------------- |
| `queryParams`    | [`ReceivableDetailsQueryParams`](#data-options)              | ✅       | Data-related options such as `invoiceId`.                                                    |
...
| Name       | Type                                                     | Required | Description                                      |
| ---------- | -------------------------------------------------------- | -------- | ------------------------------------------------ |
| `onUpdate` | `(invoice: Mercoa.InvoiceResponse \| undefined) => void` |          | Triggered when an invoice is created or updated. |
...
| Name    | Type                                                                                                        | Required | Description                              |
| ------- | ----------------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------- |
| `toast` | `{ success: (message: string) => void, error: (message: string) => void, info: (message: string) => void }` |          | Custom toast handlers for notifications. |
...
<ComponentContainer>
  <ReceivableDetails queryParams={{ invoiceId: '' }} />
  ```jsx
  <ReceivableDetails
